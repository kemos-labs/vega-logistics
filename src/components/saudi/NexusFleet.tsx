...
const TABS: { id:Tab; label:string; icon:React.ReactNode }[] = [
  ...
  { id:'ask', label:'Ask Nexus', icon:<Zap className="w-3.5 h-3.5"/> },
];

export default function NexusFleet() {
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          <h2 className="text-lg font-semibold text-[#e4e4e7] flex items-center gap-2">
            <Truck className="w-5 h-5 text-[#3b82f6]"/>Nexus Fleet — Rented Fleet Intelligence
          </h2>
  ...
  return <div className="space-y-3">
    ...
    <div className="bg-[#18181c] border border-[#2a2a33] rounded-lg p-3">
      <div className="flex items-center justify-between mb-3">
        <h3 className="text-xs font-semibold text-[#e4e4e7] flex items-center gap-2"><Shield className="w-3.5 h-3.5 text-[#a855f7]"/>Ask Nexus Recommendations</h3>
